...
describe('getModelLogoById gpt5-series mapping', () => {
  it('maps current gpt-5 series variants explicitly', () => {
    expect(getModelLogoById('gpt-5.5')).toContain('gpt-5.5.png')
    ...
    expect(getModelLogoById('gpt-5.4')).toContain('gpt-5.4.png')
    expect(getModelLogoById('gpt-5.4-pro')).toContain('gpt-5.4.png')
    expect(getModelLogoById('gpt-5.4-mini')).toContain('gpt-5.4-mini.png')
    expect(getModelLogoById('gpt-5.4-nano')).toContain('gpt-5.4-nano.png')
    expect(getModelLogoById('gpt-5.4-codex')).toContain('gpt-5-codex.png')

    expect(getModelLogoById('gpt-5.3-codex')).toContain('gpt-5.3-codex.png')
