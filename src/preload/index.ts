...
const api = {
  ...
  backup: {
    ...
    backup: (fileName: string, content: string, destinationPath: string, skipBackupFile: boolean, manifest?: string) =>
      ipcRenderer.invoke(IpcChannel.Backup_Backup, fileName, content, destinationPath, skipBackupFile, manifest),
